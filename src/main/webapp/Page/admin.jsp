...
<section id="sidebar">
    ...
    <ul class="side-menu">
        ...
        <li>
            <a href="LoginServlet" class="logout" onclick="logout()" >
                <%
                    if (session.getAttribute("email-login") != null){


                    } else{
                        response.sendRedirect("/livro_war_exploded");
                    }
                %>
                <%
...
<section id="content">
    ...
    <section id="entregas-content" class="content-item">
        <main>
            <div class="head-title">
                <div class="left">
                    <h1>Entregas</h1>
                ...
                <div class="todo">
                    ...
                    <ul class="todo-list">
                        <li class="not-completed">
                            <p>Conferir os pacotes entregues.</p>
                            <i class='bx bx-dots-vertical-rounded' ></i>
                        </li>
                        <li class="not-completed">
                            <p>Verificar pendências com transportadora.</p>
                            <i class='bx bx-dots-vertical-rounded' ></i>
                        </li>
                    </ul>
                </div>
        ...
        <main>
            ...
            <div class="table-data">
                <div class="order">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>Manutenção</td>
                            <td><span class="status process">Férias</span></td>
                        </tr>
                        <tr>
                            <td>
                                <ul class="bx bxs-group"></ul>
                ...
                <div class="todo">
                    ...
                    <ul class="todo-list">
                        <li class="not-completed">
                            <p>Verificar pontos de luz.</p>
                            <i class='bx bx-dots-vertical-rounded' ></i>
                        </li>
                        <li class="not-completed">
                            <p>Inspecionar portas e portões.</p>
                            <i class='bx bx-dots-vertical-rounded' ></i>
                        </li>
                    </ul>
                </div>
        ...
        document.getElementById('search-form').addEventListener('submit', function (e) {
            ...
            elements.forEach(function (element) {
                ...
                if (element.textContent.toLowerCase().includes(query)) {
                    ...
                    // Esconde o elemento se não corresponder à busca
