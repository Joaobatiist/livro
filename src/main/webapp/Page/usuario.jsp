...
<section id="content">
    ...
    <section id="Noticias" class="content-item active-content">
        <main>
    ...
    <section id="encomenda-content" class="content-item">
        <main>
            <div class="head-title">
                <div class="left">
                    <h1>Entregas</h1>
...
<main>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // Ativar e desativar itens do menu lateral
